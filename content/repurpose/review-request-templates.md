...
asset: Review request template pack (Phase 3 lead magnet)
compliance: No review incentives. Same outreach for every customer—do not send only happy customers to Google.
---

# Review request template pack — distribution copy

## Destination links (UTM-tagged)
...
**Suggested CTA:** Open the free web swipe file → copy SMS/email scripts → optional email for a link back to the page (not a PDF).

**Signup CTA (secondary):** `https://www.zyenereviews.com/signup?utm_source=linkedin&utm_medium=social&utm_campaign=template-pack-launch`

---

## LinkedIn — post 1 (problem + pack)
...
## LinkedIn — post 2 (industry scripts)
...
## LinkedIn — post 3 (manual vs automate)
...
- 20+ SMS & email templates for Google reviews—copy today
- The review request copy local owners actually send
...
## Founder-style announcement (short)
