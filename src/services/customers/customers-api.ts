...
const createCustomerSchema = z.object({
    ...
    /** Clients sometimes send `null`; treat as missing (empty array). */
    tags: z
...
export async function deleteCustomer(request: NextRequest) {
...
export async function patchCustomer(request: NextRequest) {
