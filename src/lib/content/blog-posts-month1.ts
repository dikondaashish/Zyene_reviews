...
export const post3: BlogPost = {
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: "Zyene Reviews leads on focused review alerts, simpler setup for owner-operators, AI-assisted replies on standard paid plans, Negative Feedback Shield (private routing before public 1-stars), competitor tracking and GBP keyword dashboards without enterprise tiers, month-to-month billing, and a 7-day trial.",
        },
        {
    ...
    body: [
        ...
        { type: "ul", items: [
            ...
            "Negative Feedback Shield: route unhappy customers to private feedback before a public 1-star.",
...
export const post4: BlogPost = {
    ...
    body: [
        ...
        { type: "tip", text: "Zyene Reviews' Negative Feedback Shield is a feature not listed in the Birdeye comparison above. It gives customers with low ratings a private way to describe the problem and alerts your team to follow up; it does not block public reviews." },
