...
export const BLOG_IMAGES: Record<string, ContentImage> = {
    "how-to-get-50-google-reviews-in-30-days": {
        src: `${BLOG_IMAGE_BASE}/google-review-request-playbook.webp`,
    ...
    "why-google-reviews-matter-in-2026": {
        src: `${BLOG_IMAGE_BASE}/why-google-reviews-matter.webp`,
    ...
    "birdeye-pricing-breakdown-2026": {
        src: `${BLOG_IMAGE_BASE}/review-software-pricing-comparison.webp`,
    ...
    "birdeye-alternatives-for-local-businesses": {
        src: `${BLOG_IMAGE_BASE}/birdeye-alternatives-cost-comparison.webp`,
    ...
    "how-to-respond-to-a-1-star-review": {
        src: `${BLOG_IMAGE_BASE}/responding-to-one-star-review.webp`,
    ...
    "ai-reply-mistakes-to-avoid": {
        src: `${BLOG_IMAGE_BASE}/ai-review-reply-oversight.webp`,
    ...
    "google-business-profile-optimization-checklist": {
        src: `${BLOG_IMAGE_BASE}/google-business-profile-audit.webp`,
    ...
    "how-reviews-impact-local-map-pack-ranking": {
        src: `${BLOG_IMAGE_BASE}/local-map-pack-visibility.webp`,
    ...
    "restaurant-owners-guide-to-google-reviews": {
        src: `${BLOG_IMAGE_BASE}/restaurant-review-management.webp`,
    ...
    "dental-practice-reputation-management-2026": {
        src: `${BLOG_IMAGE_BASE}/dental-practice-reputation.webp`,
    ...
    "true-cost-of-bad-online-reputation": {
        src: `${BLOG_IMAGE_BASE}/online-reputation-business-impact.webp`,
    ...
    "how-to-handle-fake-google-reviews": {
        src: `${BLOG_IMAGE_BASE}/fake-review-evidence.webp`,
    ...
    "negative-feedback-shield": {
        src: `${BLOG_IMAGE_BASE}/private-feedback-service-recovery.webp`,
    ...
    "ai-visibility-audit-local-businesses": {
        src: `${BLOG_IMAGE_BASE}/ai-visibility-audit.webp`,
    ...
    "how-to-respond-to-a-positive-review": {
        src: `${BLOG_IMAGE_BASE}/positive-google-review-response.webp`,
    ...
    "can-you-delete-a-google-review": {
        src: `${BLOG_IMAGE_BASE}/delete-google-review-hero.webp`,
...
export function getBlogImage(slug: string): ContentImage {
    return BLOG_IMAGES[slug] ?? {
        src: "/images/blog/covers/why-google-reviews-matter.webp",
