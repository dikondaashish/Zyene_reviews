...
const guide1: ResourceGuide = {
    ...
    body: [
        { type: "h2", id: "what-are-google-reviews", text: "What Are Google Reviews?" },
        ...
        { type: "h2", id: "how-to-get-more", text: "How to Get More Reviews" },
        ...
        { type: "h2", id: "reviews-and-ranking", text: "Reviews and Local Search Ranking" },
...
const guide2: ResourceGuide = {
    ...
    body: [
        { type: "h2", id: "before-you-respond", text: "Before You Respond: 5 Non-Negotiable Rules" },
        { type: "ol", items: [
        ...
        { type: "h2", id: "service-quality", text: "Service Quality Complaint Templates" },
        ...
        { type: "h2", id: "wait-time", text: "Wait Time & Availability Templates" },
        ...
        { type: "h2", id: "billing-pricing", text: "Billing & Pricing Templates" },
        ...
        { type: "h2", id: "staff-attitude", text: "Staff Attitude & Communication Templates" },
        ...
        { type: "h2", id: "product-quality", text: "Product Quality Templates" },
        ...
        { type: "h2", id: "vague-reviews", text: "Vague or Unverifiable Review Templates" },
        ...
        { type: "h2", id: "fake-reviews", text: "Suspected Fake Review Templates" },
        ...
        { type: "h2", id: "customization", text: "How to Customize These Templates" },
        { type: "ol", items: [
...
const guide3: ResourceGuide = {
    ...
    body: [
        ...
        { type: "h2", id: "local-link-building", text: "Section 5: Local Link Building" },
        { type: "ul", items: [
        ...
        { type: "ul", items: [
            "☐ Mobile-responsive design: Readable text, usable controls, and no horizontal page overflow on small screens",
            "☐ Core Web Vitals: LCP at or below 2.5s, INP at or below 200ms, CLS at or below 0.1 at the 75th percentile (check in Google Search Console)",
        ...
        { type: "h2", id: "schema-markup", text: "Section 7: Schema Markup" },
        { type: "ul", items: [
        ...
        { type: "h2", id: "tracking", text: "Section 8: Tracking Your Results" },
        { type: "ul", items: [
