...
export const post9: BlogPost = {
    ...
    excerpt: "A practical guide for restaurant owners who want more Google reviews, clearer responses to complaints, and a consistent way to monitor their rating.",
