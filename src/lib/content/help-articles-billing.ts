    ...
    body: [
        ...
        { type: "table", table: {
            ...
            rows: [
                ...
                ["REST API access", "✓", "✓", "✓"],
                ["Report exports", "CSV", "CSV", "Confirm scope"],
                ["Dedicated support", "✗", "✗", "✓"],
            ],
        }},
        ...
        { type: "ul", items: [
            ...
            "Professional ($59.99/mo): Best for businesses with 2-3 locations. Includes multiple locations and higher request volume.",
        ...
        { type: "tip", text: "Start with the 7-day free trial - review the selected plan, trial end date, and billing terms in checkout before starting." },
    ],
};
...
export const bill2: HelpArticle = {
    ...
    body: [
        ...
        { type: "ol", items: [
            ...
            "Open the plan options or Manage billing.",
            "Select the new plan.",
            "Review the next charge and effective date in checkout before confirming.",
...
export const bill3: HelpArticle = {
    ...
    body: [
        ...
        { type: "ul", items: [
            ...
            "Check Settings → Billing for the active usage period and reset date",
            "Unused credits do not roll over to the next month",
        ]},
        { type: "h2", text: "What Happens When You Run Out of SMS Credits" },
        { type: "p", text: "When an included channel allowance is exhausted, that channel cannot send more requests until the allowance resets or your plan changes. Check the delivery result before retrying. Do not assume an SMS request automatically became an email." },
        { type: "h2", text: "Email Review Requests" },
        { type: "p", text: "Email has a separate allowance: 500 requests per month on Starter and 700 per location on Professional. Enterprise limits follow your agreement. Email requests do not consume SMS credits." },
...
export const bill4: HelpArticle = {
    ...
    body: [
        ...
        { type: "ol", items: [
            "Go to Settings → Billing.",
            "Open Manage billing and choose the cancellation option in the billing portal.",
            "Review when access and billing will end.",
