    ...
    return new ImageResponse(
        (
            ...
            >
                ...
                <div style={{ position: "absolute", top: "10%", left: "10%", width: "400px", height: "400px", background: "radial-gradient(circle, rgba(74,222,128,0.10) 0%, transparent 70%)", borderRadius: "50%" }} />
