export const FEATURE = {
  product: {
    title: "Less admin. More possibility.",
    text: "Meet the workspace that brings your reputation together.",
    href: "/features",
    link: "Explore the platform",
    image: "/marketing/home/cafe-service.webp",
    alt: "A barista handing coffee to a customer",
  },
  solutions: {
    title: "Local roots. Bigger ambitions.",
