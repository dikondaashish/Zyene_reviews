...
export function IntegrationsHeroSection() {
    return (
        <LandingHero image={{ src: "/marketing/about/team-collaboration.png", alt: "A team working together with their everyday business tools" }}
            ...
            description="Sync Google, Facebook, and Yelp reviews in one workspace. Then use a REST API or generic inbound webhook to start fair review-request workflows after a sale, booking, or completed service."
