...
export const metadata: Metadata = {
    title: "How It Works — Zyene Reviews",
    description:
...
const STEPS = [
    {
        ...
        mockupBg: "bg-blue-500/5 border-blue-200 dark:border-blue-800",
    },
    {
        step: "02",
        icon: Bell,
        ...
        mockupBg: "bg-yellow-500/5 border-yellow-200 dark:border-yellow-800",
    },
    {
        step: "03",
        icon: Megaphone,
        ...
        mockupBg: "bg-green-500/5 border-green-200 dark:border-green-800",
        highlight: true,
    },
    {
        step: "04",
        ...
        mockupBg: "bg-purple-500/5 border-purple-200 dark:border-purple-800",
    },
];
