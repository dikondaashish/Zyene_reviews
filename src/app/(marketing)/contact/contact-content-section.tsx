            ...
            <section className="marketing-section">
                <div className="marketing-container grid grid-cols-1 gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-24">
                    <div className="space-y-8">
                        <div className="relative aspect-[1.5] overflow-hidden rounded-2xl"><Image src="/marketing/about/team-collaboration.webp" alt="A small business team working through ideas together" fill sizes="(max-width: 767px) 100vw, 40vw" /></div>
