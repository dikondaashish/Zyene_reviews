...
export const metadata: Metadata = {
    ...
    openGraph: { title: "Cookbook, Zyene Reviews Docs", description: "Code examples: POS triggers, bulk review campaigns, API automation, and reply workflows.", url: "https://www.zyenereviews.com/docs/cookbook" },
