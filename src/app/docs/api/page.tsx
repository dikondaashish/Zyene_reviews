...
export const metadata: Metadata = {
    title: "API Reference",
    description: "Zyene Reviews REST API reference. Authenticate with API keys, retrieve reviews, trigger campaigns, manage locations, and integrate with Zapier or your POS system.",
    alternates: { canonical: "https://zyenereviews.com/docs/api" },
    openGraph: { title: "API Reference — Zyene Reviews Docs", description: "Full REST API: authentication, reviews, campaigns, locations, Zapier integration.", url: "https://zyenereviews.com/docs/api" },
