                ...
                <div className="flex flex-col items-center justify-center py-20 px-6 bg-gradient-to-br from-background to-primary/10 rounded-3xl border border-primary/20 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center max-w-lg">
                        <div className="bg-gradient-to-tr from-primary to-primary/70 rounded-2xl flex items-center justify-center mb-8 rotate-2 transform transition-transform hover:rotate-0 duration-500 size-20">
                            <Star className="text-primary-foreground fill-primary-foreground size-10" />
                        </div>
                        ...
                        <div className="mt-10 grid grid-cols-2 gap-3 text-[10px] font-bold uppercase tracking-widest text-muted-foreground min-[400px]:grid-cols-4 min-[400px]:gap-4">
                            <div className="flex flex-col items-center gap-2">
                                <div className="p-2 bg-primary/10 rounded-lg text-primary"><Star className="size-4" /></div>
                                Rating Tracking
                            </div>
                            <div className="flex flex-col items-center gap-2">
                            ...
                            <div className="flex flex-col items-center gap-2">
                                <div className="p-2 bg-primary/10 rounded-lg text-primary"><PieChart className="size-4" /></div>
                                Market Share
                            </div>
                            <div className="flex flex-col items-center gap-2">
