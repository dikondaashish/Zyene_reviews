...
export default async function NotificationSettingsPage() {
  ...
  if (!access.notifications) redirect("/settings/general");
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-2 max-w-lg">
          ...
          texts, Google sign-up doesn&apos;t collect your phone.
        </p>
      </div>
      <NotificationForm businessId={businessId} key={businessId} initialPrefs={mergedPrefs} userId={user.id} />
    </div>
  );
}
