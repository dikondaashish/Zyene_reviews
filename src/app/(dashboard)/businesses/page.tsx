                            ...
                            <div
                                ...
                                className={`group relative border rounded-xl bg-card overflow-hidden transition-all duration-300 cursor-pointer ${
                                    isActive
                                        ...
                                        : "hover:-translate-y-0.5 hover:border-[#201515]/60 hover:shadow-lg"
                                    }`}
                            >
                                ...
                                >
                                    <button
                                        type="submit"
                                        className="relative z-10 w-full text-left p-5 flex flex-col gap-3 transition-colors duration-300 hover:bg-[#201515]/10 cursor-pointer"
                                    >
                                ...
                                <div className="relative z-10 flex items-center justify-between border-t bg-muted/50 px-4 py-2 transition-colors duration-300 group-hover:bg-[#201515]/10">
