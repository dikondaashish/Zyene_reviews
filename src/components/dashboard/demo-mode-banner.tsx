...
export function DemoModeBanner({ className = "" }: DemoModeBannerProps) {
    return (
        <div className={`relative group overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 rounded-2xl p-6 ${className}`}>
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-5 text-white">
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center gap-2">
                            ...
                            <Badge variant="secondary" className="bg-background/20 hover:bg-background/30 text-white border-none backdrop-blur-sm text-[10px] uppercase tracking-wider py-0 px-2 h-5">
                                Demo Mode
                            </Badge>
                        </div>
                ...
                <div className="flex items-center gap-3 shrink-0">
                    <Link href="/integrations">
                        <Button size="lg" className="bg-background text-indigo-600 hover:bg-background/90 font-bold border-none px-6 h-12 rounded-xl group/btn">
