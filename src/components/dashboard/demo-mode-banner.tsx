...
export function DemoModeBanner({ className = "" }: DemoModeBannerProps) {
    return (
        <div className={`relative group overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 rounded-2xl p-6 shadow-xl shadow-indigo-500/20 ${className}`}>
