...
export const FEATURE_VISUALS: Record<FeaturePillarSlug, { headline: string; story: string; image: string; alt: string; tab?: ProductTourTab }> = {
    ...
    "competitor-tracking": { headline: "Get to know your competitive edge.", story: "A clearer picture of your local market.", image: "/marketing/home/storefront.png", alt: "An independent local business storefront" },
    ...
    analytics: { headline: "Your reputation, in perspective.", story: "See the progress behind your everyday work.", image: "/marketing/about/team-collaboration.png", alt: "A small business team reviewing their work", tab: "reports" },
};
