        ...
        <div className="text-center space-y-3">
            ...
            >
                <div className="rounded-2xl bg-primary/10 flex items-center justify-center ring-1 ring-primary/20 mx-auto size-14">
                    <LayoutGrid className="text-primary size-7" />
                </div>
            </motion.div>
            ...
            {initialCategory && isGoogleConnected && (
                <motion.div
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-chart-2/10 border border-chart-2/35 rounded-full text-xs font-semibold text-success"
                >
