...
export function EngagementFunnelCard({
    ...
    const funnelSteps: Step[] = [
        ...
        },
        {
            ...
            value: websiteClicks,
            icon: MousePointer2,
            iconClass: "bg-chart-1/15 text-chart-1 dark:text-chart-1",
            barClass: "bg-chart-1/100 dark:bg-chart-1/100",
        },
        {
            label: "Direction requests",
            value: directionRequests,
            icon: MapPin,
            iconClass: "bg-chart-4/15 text-warning-foreground dark:text-warning-foreground",
            barClass: "bg-chart-4 dark:bg-chart-4",
        },
        {
            label: "Call clicks",
            value: callClicks,
            icon: Phone,
            iconClass: "bg-chart-2/15 text-success dark:text-success",
