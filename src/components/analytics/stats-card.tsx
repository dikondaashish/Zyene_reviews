...
export function StatsCard({ title, value, description, trend, isDemo, className }: StatsCardProps) {
    ...
    return (
        ...
        >
            <Card className="relative h-full overflow-hidden border-2 border-transparent bg-background/60 p-1 shadow-sm backdrop-blur-xl transition-all hover:border-primary/20 hover:shadow-md dark:bg-card/40">
